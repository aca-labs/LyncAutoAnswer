...
How to use it
-------------
1. Lync 2010 should be running and signed in.
2. Edit the app.config file, changing the value of sipEmailAddress to be the address you wish to monitor presence for.
